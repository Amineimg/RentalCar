...
class BookingService{
    ...
    public static function sendBookingMails($booking,$params=[]){
        ...
        $client_data=[
            ...
            "nights_number"=> isset($params["periods"]) ? $params["periods"] .' '.__('website.days') : '',
            "franchise"=> Helpers::moneyFormatDevise($booking->franchise),
            "franchise_text"=> $booking->franchise >0 ?( Helpers::moneyFormatDevise($booking->franchise) .' X ('.$params["periods"].') ' . __('website.days') .' => ' . Helpers::moneyFormatDevise($booking->franchise * $params["periods"]) ) : '',
