    ...
    public function destroy(Request $request, $id){
        if($request->ajax()) {
            if($id == 1){
                ...
                // Car Content
                $p_content = CarContent::where('language_id', $id)->get();
                ...
                */
                ...
                foreach($extraservices as $extraservice){
                    $tmp = $extraservice->extraservice;
                    unset($tmp[$language->id]);
                    $extraservice->update(['extraservice' => $tmp]);
                }
                ...
                foreach($highlights as $highlight){
                    ...
                    unset($tmp[$language->id]);
                    $highlight->update(['highlight' => $tmp]);
                }
    ...
    public function update(Request $request){
        ...
        // Create
            ...
            if(!Language::where('code', $code)->first()){
                ...
                // Car Content
                $tmp = []; $i = 0;
                $p_content = CarContent::where('language_id', $default_language->id)->get();
                foreach($p_content as $content){
