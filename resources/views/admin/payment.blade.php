                ...
                <div class="card-content no-padding">
                    <div class="blue-card card-stats-body waves-effect">
                        ...
                        <div class="stats-text left-align">
                            <strong class="counter">{{ $total_admin }}</strong> {{ $currency  }}<br>
                            <span>{{get_string('admin_total_payment')}}</span>
                        </div>
                    </div>
                </div><!--end .card-body -->
            </div>
            ...
            <div class="card">
                <div class="card-content no-padding">
                    <div class="blue-card card-stats-body waves-effect">
                        ...
                        <div class="stats-text left-align">
                            <strong class="counter">{{ $total_other }}</strong> {{ $currency  }}<br>
                            <span>{{get_string('owner_total_payment')}}</span>
                        </div>
                    </div>
                </div><!--end .card-body -->
            </div>
            ...
            <div class="card">
                <div class="card-content no-padding">
                    <div class="blue-card card-stats-body waves-effect">
                        ...
                        <div class="stats-text left-align">
                            <strong class="counter">{{ $total }}</strong> {{ $currency  }}<br>
                            <span>{{get_string('admin_total_earning')}}</span>
                        </div>
                    </div>
                </div><!--end .card-body -->
            </div>
            ...
            <table class="table bordered striped">
                ...
                @foreach($payments as $payment)
                    <tr>
                        ...
                        <td>@if($payment->car_id && $payment->car) {{ $payment->car->contentDefault->name }} @else <i class="small material-icons color-red">clear</i> @endif </td>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.user-info').click(function(e){
            ...
            var token = $('.token').val();
            $.ajax({
                url: '{{ url('/admin/payment/details') }}/' + id,
                type: 'post',
                data: {_token: token},
