...
<div class="col s12">
    ...
    @endif
    {!!Form::open(['method' => 'patch', 'url' => route('admin.service.update', $service->id), 'files' => 'true'])!!}
    <div class="panel">
                ...
                <div id="data-panel" class="tab-pane">
                    ...
                    <div class="col l3 m4 s6 right right-align mbot0">
                        <div class="form-group">
                            <div class="switch">
                                <label>
                                    {{get_string('standard')}}{{ Form::checkbox('featured', $service->featured, false, ['value' => $service->featured, 'id' => 'activeSwitch', 'class' => 'form-control', $service->featured ? 'checked': ''])}}<span class="lever"></span>{{get_string('featured')}}
                                </label>
                            </div>
                        </div>
                    </div>
