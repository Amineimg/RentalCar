...
<div class="col l6 m6 s12 pull-right">
    ...
    <div class="boxed-legend-3">
        <span>{{ get_string('desabled_days') }}</span>
    </div>
    <div class="boxed-legend-1">
    ...
    {!! Form::open(['method' => 'post', 'url' => route('admin_car_update_dates')])!!}
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        // Get Owner dates
        var dates = [];
        @if(!empty($car->prop_dates) && $car->prop_dates->dates)
            @foreach($car->prop_dates->dates as $date)
