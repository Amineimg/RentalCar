        ...
        <div class="panel-body">
            <div class="tab-content">
                <div id="general_settings" class="tab-pane active">
                    ...
                    <div class="col m6 s12">
                        <div class="form-group  {{$errors->has('allow_add_car_button') ? 'has-error' : ''}}">
                            {{Form::label('allow_add_car_button', get_string('allow_add_car_button'))}}
                            {{Form::select('allow_add_car_button', ['0' => get_string('no'), '1' => get_string('yes')], get_setting('allow_add_car_button', 'design'), ['class' => 'form-control'])}}
                            @if($errors->has('allow_add_car_button'))
                                <span class="wrong-error">* {{$errors->first('allow_add_car_button')}}</span>
                            @endif
                        </div>
                    </div>
                </div>
                <div id="home_settings" class="tab-pane">
                    ...
                    <div class="col l4 m4 s6">
                        <div class="form-group  {{$errors->has('show_featured_cars') ? 'has-error' : ''}}">
                            {{Form::label('show_featured_cars', get_string('show_featured_cars'))}}
                            {{Form::select('show_featured_cars', ['0' => get_string('no'), '1' => get_string('yes')], get_setting('show_featured_cars', 'design'), ['class' => 'form-control'])}}
                            @if($errors->has('show_featured_cars'))
                                <span class="wrong-error">* {{$errors->first('show_featured_cars')}}</span>
                            @endif
                        </div>
                    </div>
                    <div class="col l4 m4 s6">
                    ...
                    <ul class="collapsible" data-collapsible="accordion">
                        <li>
                            <div class="collapsible-header">
                                <span>{{get_string('featured_cars_section')}}</span>
                            ...
                            <div class="collapsible-body">
                                @if(get_setting('show_featured_cars', 'design'))
                                    <div class="row">
                                        <div class="col s12">
                                            <div class="col m6 s12">
                                                <div class="form-group  {{$errors->has('fp_cars_count') ? 'has-error' : ''}}">
                                                    {{Form::text('fp_cars_count', get_setting('fp_cars_count', 'design'), ['class' => 'form-control', 'placeholder' => get_string('fp_cars_count')])}}
                                                    {{Form::label('fp_cars_count', get_string('fp_cars_count'))}}
                                                    @if($errors->has('fp_cars_count'))
                                                        <span class="wrong-error">* {{$errors->first('fp_cars_count')}}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col m6 s12">
                    ...
                    <div class="panel-heading">
                        <ul class="nav nav-tabs">
                            @foreach($languages as $language)
                                <li class="tab {{$language->default ? 'active' : ''}}"><a href="#lang{{$language->id}}" data-toggle="tab"><img src="{{asset($language->flag)}}"/><span>{{$language->language}}</span></a></li>
                            @endforeach
                        </ul>
                    </div>
                    <div class="panel-body">
