            ...
            <div class="tab-content">
                <div id="general_settings" class="tab-pane active">
                    ...
                    <div class="col l6 m6 s6">
                        <div class="form-group  {{$errors->has('measurement_unit') ? 'has-error' : ''}}">
                            ...
                            {{Form::select('measurement_unit', ['m²' => 'm²', 'ft' => 'ft'], get_setting('measurement_unit', 'site'), ['class' => 'form-control'])}}
                ...
                <div id="contact" class="tab-pane">
                    <div class="col l2 m3 s12">
                        <div class="form-group  {{$errors->has('contact_name1') ? 'has-error' : ''}}">
                            {{Form::label('contact_name1', get_string('contact_name1'))}}
                            {{Form::text('contact_name1', get_setting('contact_name1', 'site'), ['class' => 'form-control', 'placeholder' => get_string('contact_name1')])}}
                            @if($errors->has('contact_name1'))
                                <span class="wrong-error">* {{$errors->first('contact_name1')}}</span>
                            @endif
                        </div>
                    </div>
                    <div class="col l2 m3 s12">
                    ...
                    <div class="col l2 m3 s12">
                        <div class="form-group  {{$errors->has('contact_name2') ? 'has-error' : ''}}">
                            {{Form::label('contact_name2', get_string('contact_name2'))}}
                            {{Form::text('contact_name2', get_setting('contact_name2', 'site'), ['class' => 'form-control', 'placeholder' => get_string('contact_name2')])}}
                            @if($errors->has('contact_name2'))
                                <span class="wrong-error">* {{$errors->first('contact_name2')}}</span>
                            @endif
                        </div>
                    </div>
                    <div class="col l2 m3 s12">
                    ...
                    <div class="col l2 m3 s12">
                        <div class="form-group  {{$errors->has('contact_name3') ? 'has-error' : ''}}">
                            {{Form::label('contact_name3', get_string('contact_name3'))}}
                            {{Form::text('contact_name3', get_setting('contact_name3', 'site'), ['class' => 'form-control', 'placeholder' => get_string('contact_name3')])}}
                            @if($errors->has('contact_name3'))
                                <span class="wrong-error">* {{$errors->first('contact_name3')}}</span>
                            @endif
                        </div>
                    </div>
                    <div class="col l2 m3 s12">
                        <div class="form-group  {{$errors->has('contact_tel3') ? 'has-error' : ''}}">
