            ...
            <table class="table bordered striped">
                ...
                @foreach($reviews as $review)
                    <tr class="{{ $review->status ? 'disabled-style' : '' }}">
                        ...
                        <td>@if($review->car_id && $review->car){{$review->car->contentDefault->name}}@elseif($review->service_id && $review->service){{ $review->service->contentDefault->name }}@else<i class="small material-icons color-red">clear</i> @endif</td>
                        ...
                        <td>
                            <div class="icon-options">
                                ...
                                <a href="#" class="confirm-button" style="display: none;" data-id="{{$review->id}}" title="{{get_string('accept_review')}}"><i class="small material-icons color-primary">done</i></a>
                                <a href="#" class="dismiss-button" style="display: inline-block;" data-id="{{$review->id}}" title="{{get_string('dismiss_review')}}"><i class="small material-icons color-red">close</i></a>
                                @else
                                <a href="#" class="confirm-button" style="display: inline-block;" data-id="{{$review->id}}" title="{{get_string('accept_review')}}"><i class="small material-icons color-primary">done</i></a>
                                <a href="#" class="dismiss-button" style="display: none;" data-id="{{$review->id}}" title="{{get_string('dismiss_review')}}"><i class="small material-icons color-red">close</i></a>
                                @endif
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.confirm-button').click(function(event){
                ...
                var dismiss_button = $('.dismiss-button', selector);
            ...
            $('.dismiss-button').click(function(event){
                ...
                if(selector.hasClass('disabled-style')) {
                    bootbox.confirm({
                        title: '{{get_string('confirm_action')}}',
                        message: '{{get_string('disapprove_review_confirm')}}',
                        onEscape: true,
                        backdrop: true,
                        buttons: {
                            cancel: {
                            ...
                            if (result) {
                                $.ajax({
                                    ...
                                    success: function (msg) {
                                        ...
                                        status.html('{{get_string('disapproved')}}');
                                        toastr.success(msg);
                                    },
                                    error: function (msg) {
                                        toastr.error(msg.responseJSON);
