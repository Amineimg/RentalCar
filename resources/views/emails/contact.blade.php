            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td style="{{ $style['email-masthead'] }}">
                        <a style="{{ $style['email-masthead_name'] }}" href="{{ url('/') }}" target="_blank">Jacaranda car</a>
                    </td>
                </tr>
                            ...
                            <tr>
                                <td style="{{ $style['email-body_cell'] }}">
                                    ...
                                    <h1 style="{{ $style['header-1'] }}">
                                            Message de  : {{ $mail_data['name'] }}                                    
                                    </h1>

                                    <!-- Intro -->
                                    <p style="{{ $style['paragraph'] }}">
                                        <label>E-mail  :</label>{{ $mail_data['email'] }} <br>
                                        <label>Téléphone    :</label>{{ $mail_data['phone'] }} <br>
