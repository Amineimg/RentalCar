...
<head>
    ...
    <link href="{{ asset('assets/css/plugins/backend_materialize.min.css')}}" rel="stylesheet">

    <link href="{{ asset('assets/css/plugins/jquery-ui.min.css')}}" rel="stylesheet">

    <link href="{{ asset('assets/css/plugins/toast.min.css')}}" rel="stylesheet">

    <link href="{{ asset('assets/css/plugins/summernote.min.css')}}" rel="stylesheet">

    <link href="{{ asset('assets/css/plugins/dropzone.min.css')}}" rel="stylesheet">

    <link href="{{ asset('assets/css/plugins/colorpicker.css')}}" rel="stylesheet">
                ...
                <div id="header-left" class="col l10 m12 s12 header-col">
                    ...
                    <div id="navigation">
                        ...
                        <ul class="hide-on-med-and-down clearfix">
                            ...
                            <li class="{{ setActive('admin/dashboard') }}">
                                ...
                                <a href="{{route('admin_dashboard')}}">{{get_string('dashboard')}}</a>

                            </li>

                            --}}

                            <li class="{{ setActive('admin/car') }}"><a href="{{route('admin.car.index')}}">{{get_string('cars')}}</a></li>
                            ...
                            <li class="{{ setActive('admin/taxonomy') }}">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="{{route('admin.taxonomy.carmake.index')}}">{{get_string('car_makes')}}</a></li>

                                    <li><a href="{{route('admin.taxonomy.carmodel.index')}}">{{get_string('car_models')}}</a></li>
                                    ...
                                    <li><a href="{{route('admin_taxonomy_highlight')}}">{{get_string('highlights')}}</a></li>

                                    <li><a href="{{route('admin_taxonomy_service')}}">{{get_string('services')}}</a></li>

                                    <li><a href="{{route('admin_taxonomy_extraservice')}}">{{get_string('extra_services')}}</a></li>

                                </ul>

                            </li>

                            <li class="{{ setActive('admin/booking') }}">

                                <a href="{{route('admin_booking')}}">{{get_string('bookings')}}</a>
                            ...
                            <li class="{{ setActive('admin/settings') }}">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="{{route('admin_car_settings')}}">{{get_string('cars_settings')}}</a></li>
                    ...
                    <div class="col s6 show-on-small">
                        ...
                        <ul id="slide-out" class="side-nav">
                            ...
                            <li class="{{ setActive('admin/car') }}"><a href="{{route('admin.car.index')}}">{{get_string('car')}}</a></li>
                            ...
                            <li class="{{ setActive('admin/review') }}"><a href="{{route('admin_review')}}">{{get_string('car')}}</a></li>
...
<script src="{{asset('assets/js/plugins/backend_bootstrap.min.js')}}" defer></script>

<script src="{{asset('assets/js/plugins/backend_plugins.min.js')}}" defer></script>

<script src="{{asset('assets/js/plugins/waypoints.min.js')}}" defer></script>
...
<script src="{{asset('assets/js/plugins/counter.min.js')}}"></script>

<script src="{{asset('assets/js/plugins/summernote.min.js')}}"></script>

<script src="{{asset('assets/js/plugins/dropzone.min.js')}}"></script>

<script src="{{asset('assets/js/plugins/colorpicker.min.js')}}"></script>

<script src="{{asset('assets/js/plugins/bootbox.min.js')}}"></script>

<script src="{{asset('assets/js/backend_init.js')}}"></script>
