                    ...
                    <div id="navigation">
                        <ul class="hide-on-med-and-down clearfix">
                            <li class="{{ setActive('owner/dashboard') }}"><a href="{{route('owner_dashboard')}}">{{get_string('dashboard')}}</a></li>
                                ...
                                <li class="{{ setActive('owner/car') }}"><a href="{{route('owner.car.index')}}">{{get_string('cars')}}</a></li>
...
<script src="{{asset('assets/js/plugins/backend_bootstrap.min.js')}}"></script>
<script src="{{asset('assets/js/plugins/backend_plugins.min.js')}}"></script>
