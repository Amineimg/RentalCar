@extends('layouts.home_layout', ['static_data' => $static_data, 'page_style' => 'home_explore'])
...
@section('title')
    ...
    <meta car="og:title" content="{{$static_data['strings']['explore'] .' - '. $static_data['strings']['services']}}" />
                            ...
                            <div class="carousel-inner" role="listbox">
                                ...
                                @foreach($service->images as $image)
                                    <div class="carousel-item @if(!$c) active <?php $c++; ?> @endif">
                                        <img class="responsive-img" src="{{ asset('images/data').'/'.$image->image }}"/>
                                    </div>
                                @endforeach
                            </div>
...
@section('footer')
    ...
    <script src="{{asset('assets/js/plugins/clusters.min.js')}}"></script>
