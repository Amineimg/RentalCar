            ...
            <div class="col-sm-12">
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tr>
                            <th>{{$static_data['strings']['car']}}</th>
                            <th>{{$static_data['strings']['start_date']}}</th>
                            <th>{{$static_data['strings']['end_date']}}</th>
                            <th>{{$static_data['strings']['passengers_number']}}</th>
                        ...
                        @foreach($bookings as $booking)
                            <tr>
                                <td>@if($booking->car_id) {{ $booking->car->contentload->name }} @else {{ $booking->service->contentDefault->name }} @endif</td>
