...
@section('content')
    <div class="row  marginalized justify-content-center">
        <div class="col-sm-12"><h1 class="section-title-dark">{{$static_data['strings']['reset_password']}}</h1></div>
        <div class="col-sm-12 col-md-8 input-style">
            @if (Session::has('status'))
                <p class="section-subtitle-light text-centered green-color"><strong>{{ $static_data['strings']['we_sent_reset_mail'] }}</strong></p>
            @endif
