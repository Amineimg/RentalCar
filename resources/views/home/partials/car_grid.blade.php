<div class="item box-shadow" data-rooms="{{$car->rooms}}">
    <div id="carousel-_{{$car->id}}" class="main-image bg-overlay carousel slide" data-ride="carousel" data-interval="false">
        ...
        ?>
        <a href="#" class="add-wishlist" data-id="{{$car->id}}" style="{{$a_wish}}"><i class="fa fa-heart-o"></i></a>
        ...
        <div class="item-category"><i class="fa fa-map-marker"></i> {{ $car->prop_location->contentload->location }}</div>
        <div class="price">
