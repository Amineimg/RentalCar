                        ...
                        <div class="col-md-6">
                            ...
                            <div class="copyright-menu">
                                <div class="vistors-details">
                                    <ul class="d-flex">
                                        <li><a href="javascript:void(0)"><img class="img-fluid" src="{{URL::asset('/front/build/img/icons/paypal.svg')}}" alt="Paypal"></a></li>
...
<footer class="footer-two">
    <div class="sec-bg">
        ...
        <img src="{{URL::asset('/front/build/img/bg/anchor-img-02.png')}}" alt="Img">
    </div>
    <div class="container">
        ...
        <div class="footer-bottom">
            ...
            <div class="app-store-links d-flex align-items-center">
                <span class="me-2"><a href="javascript:void(0);"><img src="{{URL::asset('/front/build/img/icons/google-play.svg')}}" alt="Img"></a></span>
                <span><a href="javascript:void(0);"><img src="{{URL::asset('/front/build/img/icons/app-store.svg')}}" alt="Img"></a></span>
            </div>
        </div>
    </div>
</footer>
                ...
                <div class="col-lg-2">
                    <div class="footer-contact footer-widget">
                        <div class="footer-logo">
                            <img src="{{URL::asset('/front/build/img/logo.svg')}}" class="img-fluid aos" alt="logo">
                        </div>
                        <div class="footer-contact-info">
                        ...
                        <ul class="store-icon">
                            <li>
                                <a href="javascript:void(0);">
                                    <img src="{{URL::asset('/front/build/img/icons/play-icon.svg')}}" class="img-fluid" alt="logo">
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);">
                                    <img src="{{URL::asset('/front/build/img/icons/app-icon.svg')}}" class="img-fluid" alt="logo">
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="footer-list">
                            <ul>
                                <li class="country-flag">
                                    <div class="dropdown">
                                        <a class="dropdown-toggle nav-tog" data-bs-toggle="dropdown" href="javascript:void(0);">
                                            <img src="{{URL::asset('/front/build/img/flags/us.png')}}" alt="Img">English
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="javascript:void(0);" class="dropdown-item">
                                                <img src="{{URL::asset('/front/build/img/flags/fr.png')}}" alt="Img">French
                                            </a>
                                            <a href="javascript:void(0);" class="dropdown-item">
                                                <img src="{{URL::asset('/front/build/img/flags/es.png')}}" alt="Img">Spanish
                                            </a>
                                            <a href="javascript:void(0);" class="dropdown-item">
                                                <img src="{{URL::asset('/front/build/img/flags/de.png')}}" alt="Img">German
                                            </a>
                                        </div>
                                    </div>
                                </li>
                                <li class="country-flag lang-nav">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a href="javascript:void(0);" class="dropdown-item">
                                            <img src="{{URL::asset('/front/build/img/flags/fr.png')}}" alt="Img">Euro
                                        </a>
                                        <a href="javascript:void(0);" class="dropdown-item">
                                            <img src="{{URL::asset('/front/build/img/flags/es.png')}}" alt="Img">INR
                                        </a>
                                    </div>
                                    </div>
                                </li>
