                ...
                <nav class="navbar navbar-expand-lg header-nav">
                    <div class="navbar-header">
                        ...
                        <a href="{{ url('/') }}" class="navbar-brand logo">
                            <img src="{{ URL::asset('/front/build/img/logo.svg') }}" class="img-fluid" alt="Logo">
                        </a>
                        <a href="{{ url('/') }}" class="navbar-brand logo-small">
                            <img src="{{ URL::asset('/front/build/img/logo-small.png') }}" class="img-fluid"
                                alt="Logo">
                        </a>
                    </div>
                    <div class="main-menu-wrapper">
                        ...
                        <ul class="main-nav">
                            <li class="has-submenu {{ Request::is('/', 'index-2', 'index-3') ? 'active' : '' }}">
                                <a href="{{ url('/') }}">Home <i class="fas fa-chevron-down"></i></a>
                                <ul class="submenu">
                                    <li class="{{ Request::is('/') ? 'active' : '' }}"><a href="{{ url('/') }}">Home
                                            1</a></li>
                                    <li class="{{ Request::is('index-2') ? 'active' : '' }}"><a
                                            href="{{ url('index-2') }}">Home 2</a></li>
                                    <li class="{{ Request::is('index-3') ? 'active' : '' }}"><a
                                            href="{{ url('index-3') }}">Home 3</a></li>
                                </ul>
                            </li>
                            <li
                            ...
                            <li
                                ...
                                <ul class="submenu">
                                    ...
                                    <li
                                        ...
                                        <ul class="submenu">
                                            <li
                                                class="{{ Request::is('booking-checkout', 'booking-payment') ? 'active' : '' }}">
                                                <a href="{{ url('booking-checkout') }}">Booking Checkout</a></li>
                        ...
                        <ul class="nav header-navbar-rht">
                            ...
                            <li class="nav-item dropdown logged-item noti-nav noti-wrapper">
                                <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                                    <span class="bell-icon"><img
                                            src="{{ URL::asset('front/build/img/icons/bell-icon.svg') }}"
                                            alt="Bell"></span>
                                            ...
                                            <li class="notification-message">
                                                <a href="#">
                                                    <div class="media d-flex">
                                                        <span class="avatar avatar-lg flex-shrink-0">
                                                            <img class="avatar-img rounded-circle" alt="User Image"
                                                                src="{{ URL::asset('front/build/img/profiles/avatar-04.jpg') }}">
                                                        </span>
                                                        <div class="media-body flex-grow-1">
     ...
     @if (Route::is(['forgot-password', 'login', 'register', 'reset-password']))
         ...
         <header class="log-header">
             <a href="{{ url('/') }}"><img class="img-fluid logo-dark"
                     src="{{ URL::asset('/front/build/img/logo.svg') }}" alt="Logo"></a>
         </header>
         <!-- /Header -->
     @endif
                                    ...
                                    <div class="header-top-drpodowns me-3">
                                        <div class="dropdown header-dropdown country-flag">
                                            <a class="dropdown-toggle nav-tog" data-bs-toggle="dropdown"
                                                ...
                                                <img src="{{ URL::asset('/front/build/img/flags/us.png') }}"
                                                    alt="Img">English
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a href="javascript:void(0);" class="dropdown-item">
                                                    <img src="{{ URL::asset('/front/build/img/flags/fr.png') }}"
                                                        alt="Img">French
                                                </a>
                                                <a href="javascript:void(0);" class="dropdown-item">
                                                    <img src="{{ URL::asset('/front/build/img/flags/es.png') }}"
                                                        alt="Img">Spanish
                                                </a>
                                                <a href="javascript:void(0);" class="dropdown-item">
                                                    <img src="{{ URL::asset('/front/build/img/flags/de.png') }}"
                                                        alt="Img">German
                                                </a>
                                            </div>
                                        </div>
                ...
                <div class="container">
                    <nav class="navbar navbar-expand-lg header-nav">
                        <div class="navbar-header">
                            ...
                            <a href="{{ url('/') }}" class="navbar-brand logo">
                                <img src="{{ URL::asset('/front/build/img/logo-2.svg') }}" class="img-fluid"
                                    alt="Logo">
                            </a>
                            <a href="{{ url('/') }}" class="navbar-brand logo-small">
                                <img src="{{ URL::asset('/front/build/img/logo-small.png') }}" class="img-fluid"
                        ...
                        <div class="main-menu-wrapper">
                            ...
                            <ul class="main-nav">
                                <li class="has-submenu active">
                                    <a href="{{ url('/') }}">Home <i class="bx bxs-down-arrow"></i></a>
                                    <ul class="submenu">
                                        <li><a href="{{ url('/') }}">Home 1</a></li>
                                        <li class="active"><a href="{{ url('index-2') }}">Home 2</a></li>
            ...
            <section class="banner-section banner-sec-two banner-slider">
                <div class="banner-img-slider owl-carousel">
                    <div class="slider-img">
                        <img src="{{ URL::asset('/front/build/img/bg/home-banner-img.png') }}" alt="Img">
                    </div>
                    <div class="slider-img">
                        <img src="{{ URL::asset('/front/build/img/bg/home-banner-img-02.png') }}" alt="Img">
                    </div>
                    <div class="slider-img">
                                    ...
                                    <div class="banner-form">
                                        <form action="{{ route("search_home") }}" method="post">
                                                            ...
                                                            <div class="date-widget">
                                                                <div class="group-img">
                                                                    <input type="text" class="form-control datetimepicker" name="start_date"
                                                                        placeholder="04/11/2023" data-min-date="2024-03-25">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="input-block">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="banner-search-list">
                                                    <div class="input-block">
                                                        <label><i class="bx bx-map"></i>DropOff Location</label>
