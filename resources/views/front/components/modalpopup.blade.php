                ...
                <div class="modal-body">
                    <div class="booking-header">
                        <div class="booking-img-wrap">
                            <div class="book-img">
                                <img src="{{ URL::asset('/front/build/img/cars/car-05.jpg') }}" alt="img">
                            </div>
                            <div class="book-info">
                ...
                <div class="modal-body">
                    <div class="order-success-info">
                        <span class="order-success-icon">
                            <img src="{{ URL::asset('/front/build/img/icons/check-icon.svg') }}" alt="Icon">
                        </span>
                        <h4>Successful</h4>
                    ...
                    <div class="call-box incoming-box">
                        <div class="call-wrapper">
                            <div class="call-inner">
                                <div class="call-user">
                                    <img alt="User Image" src="{{ URL::asset('/front/build/img/profiles/avatar-08.jpg') }}"
                                        class="call-avatar">
                                    <h4>Darren Elder</h4>
                            ...
                            <div class="call-inner">
                                <div class="call-user">
                                    <img class="call-avatar"
                                        src="{{ URL::asset('/front/build/img/profiles/avatar-08.jpg') }}" alt="User Image">
                                    <h4>Darren Elder</h4>
                                    <span>Calling ...</span>
                                </div>
                                <div class="call-items">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <div class="invoice-logo">
                                        <img src="{{ URL::asset('/front/build/img/logo.svg') }}" alt="logo">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="invoice-sign">
                                        <img class="img-fluid d-inline-block"
                                            src="{{ URL::asset('/front/build/img/signature.png') }}" alt="Sign">
                            ...
                            <div class="col-md-6">
                                <div class="modal-form-group">
                                    ...
                                    <div class="form-icon">
                                        ...
                                        <span class="cus-icon">
                                            <img src="{{ URL::asset('/front/build/img/icons/lock-icon.svg') }}"
                                                alt="Icon">
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="modal-form-group">
                                    ...
                                    <div class="form-icon">
                                        ...
                                        <span class="cus-icon">
                                            <img src="{{ URL::asset('/front/build/img/icons/calendar-icon.svg') }}"
                                                alt="Icon">
                                        </span>
                                    </div>
                                </div>
                    ...
                    <div class="choose-payment-info">
                        ...
                        <div class="choose-payment">
                            <label class="custom_radio">
                                ...
                                <span class="checkmark"></span>
                                <img src="{{ URL::asset('/front/build/img/icons/payment-1.svg') }}" alt="Icon">
                            </label>
                            <label class="custom_radio">
                                <input type="radio" name="payment_one" value="wallet_one">
                                <span class="checkmark"></span>
                                <img src="{{ URL::asset('/front/build/img/icons/payment-2.svg') }}" alt="Icon">
                            </label>
                            <label class="custom_radio">
                                <input type="radio" name="payment_one" value="wallet_one" checked="">
                                <span class="checkmark"></span>
                                <img src="{{ URL::asset('/front/build/img/icons/payment-3.svg') }}" alt="Icon">
                            </label>
                        </div>
                                                ...
                                                <td>
                                                    <label class="custom_radio">
                                                        <input type="radio" name="payment_two" value="wallet_two"
                                                            checked="">
                                                        <span class="checkmark"></span>
                                                        <img src="{{ URL::asset('/front/build/img/icons/wallet-01.svg') }}"
                                                            alt="Icon">
                                                    </label>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <label class="custom_radio">
                                                        <input type="radio" name="payment_two" value="wallet_two">
                                                        <span class="checkmark"></span>
                                                        <img src="{{ URL::asset('/front/build/img/icons/wallet-02.svg') }}"
                                                            alt="Icon">
                                                    </label>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <label class="custom_radio">
                                                        <input type="radio" name="payment_two" value="wallet_two">
                                                        <span class="checkmark"></span>
                                                        <img src="{{ URL::asset('/front/build/img/icons/wallet-03.svg') }}"
                                                            alt="Icon">
                                                    </label>
                                                </td>
                                                <td>
                        ...
                        <div class="booking-wrapper">
                            ...
                            <div class="card-status-wrap">
                                ...
                                <div class="status-img">
                                    <img src="{{ URL::asset('/front/build/img/icons/card-icon.svg') }}" alt="">
                                </div>
                            </div>
                ...
                <div class="refund-wrap booking-group">
                    <div class="booking-wrapper">
                        ...
                        <div class="card-status-wrap">
                            ...
                            <div class="status-img">
                                <img src="{{URL::asset('/front/build/img/icons/card-icon.svg')}}" alt="Img">
                            </div>
                        </div>
                        <div class="refund-process">
                            <h5>Refund Process</h5>
								...
								<div class="login-auth-wrap">
									...
									<form action="{{url('index')}}">
										...
										<div class="social-login">
											<a href="#" class="d-flex align-items-center justify-content-center input-block btn google-login w-100"><span><img src="{{URL::asset('/front/build/img/icons/google.svg')}}" class="img-fluid" alt="Google"></span>Log in with Google</a>
										</div>
										<div class="social-login">
											<a href="#" class="d-flex align-items-center justify-content-center input-block btn google-login w-100"><span><img src="{{URL::asset('/front/build/img/icons/facebook.svg')}}" class="img-fluid" alt="Facebook"></span>Log in with Facebook</a>
										</div>
										<!-- /Social Login -->
