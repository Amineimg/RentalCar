                        ...
                        <ul>
                            <li>
                                <a href="{{ url('user-dashboard') }}"
                                    ...
                                    <img src="{{ URL::asset('/front/build/img/icons/dashboard-icon.svg') }}" alt="Icon">
                                    <span>Dashboard</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('user-bookings') }}"
                                    class="{{ Request::is(
                                        ...
                                        ? 'active'
                                        : '' }}">
                                    <img src="{{ URL::asset('/front/build/img/icons/booking-icon.svg') }}" alt="Icon">
                            ...
                            <li>
                                <a href="{{ url('user-reviews') }}"
                                    ...
                                    <img src="{{ URL::asset('/front/build/img/icons/review-icon.svg') }}" alt="Icon">
                                    <span>Reviews</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('user-wishlist') }}"
                                    ...
                                    <img src="{{ URL::asset('/front/build/img/icons/wishlist-icon.svg') }}" alt="Icon">
                                    <span>Wishlist</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('user-messages') }}"
                                    ...
                                    <img src="{{ URL::asset('/front/build/img/icons/message-icon.svg') }}" alt="Icon">
                                    <span>Messages</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('user-wallet') }}"
                                    ...
                                    <img src="{{ URL::asset('/front/build/img/icons/wallet-icon.svg') }}" alt="Icon">
                                    <span>My Wallet</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('user-payment') }}"
                                    ...
                                    <img src="{{ URL::asset('/front/build/img/icons/payment-icon.svg') }}" alt="Icon">
                                    <span>Payments</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('user-settings') }}"
                                    ...
                                    <img src="{{ URL::asset('/front/build/img/icons/settings-icon.svg') }}" alt="Icon">
                                    <span>Settings</span>
                                </a>
                            </li>
                        </ul>
